    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="pricing.php">Harga</a></li>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Harga Undangan Digital</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Daftar Paket, Harga Undangan Digital Kami.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            ...
            <p>Pilih Paket Sesuai Kebutuhan Kalian.</p>
          </div>
        </div>
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="pricing h-100 text-center popular">
              <span class="popularity">Recommended</span>
              <h3>Platinum</h3>
              <ul class="list-unstyled">
                <li>Nah Mending Yang ini</li>
                <li>Ini Udah Pasti Bagus</li>
                <li>Fitur nya Juga Lengkap Boss</li>
              </ul>
              <div class="price-cta">
                <strong class="price">Rp99.999</strong>
                <p><a href="#" class="btn btn-white">Pilih Paket</a></p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="pricing h-100 text-center">
              ...
              <h3>Gold</h3>
              <ul class="list-unstyled">
                <li>Mending Platinum Sih</li>
                <li>Kata Gua mah Yaa</li>
                <li>Fitur nya kurang lengkap pula</li>
              </ul>
              <div class="price-cta">
