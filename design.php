          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Design Undangan</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Pilihan Design Undangan Digital Kami.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="post-entry">
              <a href="design/Design1.php" class="d-block mb-4">
                <img src="assets/img/thumbnail1.png" alt="Image" class="img-fluid">
              </a>
              <div class="post-text">
